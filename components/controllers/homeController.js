angularRoutingApp.controller("homeController", function ($scope, $state, $http, $timeout, $window, alerta, preload) {
  $scope.educacion = [
    ...
    {
      nombre: "Flutter:Tu guía completa de desarrollo para IOS y Android",
      periodo: "Marzo",
      institucion: "Udemy",
    },
    {
      nombre: "Construyendo Web APIs RESTful con ASP.NET Core 3.1",
      periodo: "Agosto 2020",
      institucion: "Udemy",
    },
    {
    ...
    {
      nombre: "Scrum Master + Liderar Equipos Scrum y Ágil",
      periodo: "Febrero 2021",
      institucion: "Udemy",
    },
    {
      nombre: "Certification of completion –oficial NestJS course",
      periodo: "Abril 2021",
      institucion: "Udemy",
    },
  ];
  ...
  $scope.testimonios = [
    {
      nombre: "Felipe Vega",
      testimonio:
        "Yeison is a very talented software engineer who's always committed to the code duties. Among his multiple technical skills at integrating presentation layer with back-end layer, he has the ability to come up with solutions for complex challenges very quickly. He's always open to suggestions when it comes to receive feedback regarding his code. He has the potential to become a key player at any software development team.",
...

    {
      ...
      testimonio:
        " Laboró bajo mi supervisión desde el 4 de mayo del año 2015 en los diferentes aplicativos del centro y su desenvolvimiento resultó muy satisfactorio tanto para mi, como para la empresa que representó",
  ...
  $scope.experiencia = [
    ...
    },
    {
      ...
      funcion:
        "Desarrollo web, front-end en labores de apoyo en la implementación de los aplicativos del centro desde el punto de vista de funcionalidad. Manejo de muro de visualización de datos.",
    },
    {
    ...
    {
      nombre: "Universidad de Manizales",
      tiempo: "24 de Agosto de 2020 - 31 de Diciembre de 2020",
      funcion: "Apoyo en desarrollo web en las plataformas del área de analítica de Datos . (Datalab Consultoría en transformación Digital)",
    },
    {
      nombre: "PersonalSoft",
      tiempo: "02 de Febrero - Actualmente",
      funcion: "Apoyo en los aplicativos de cliente Leal, y célula de usuarios desde el punto de vista de backend",
    },
  ];
  ...
  $scope.distinciones = [
    ...
    {
      distincion: "Freelancer preferente en la plataforma https://www.freelancer.com/",
    },
  ];
